  ...
  return (
    <div className="navbar  glass-effect bg-base-200 py-1 my-4 min-h-0 z-1 shadow-sm rounded-full glass-card max-w-7xl">
      <div className="navbar-start">
        ...
        <Link
          to={"/"}
          className="flex items-center gap-1 text-sm sm:text-xl font-bold"
        >
      ...
      <div className="navbar-end gap-3">
        {user ? (
          ...
          <Link
            to={"/auth/login"}
            className="btn rounded-full border-gray-300  btn-sm bg-linear-to-r from-primary to-secondary text-white"
          >
            {" "}
            <IoLogIn /> Login
          </Link>
